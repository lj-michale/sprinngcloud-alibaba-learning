...
public class ApiTest {
    ...
    public void test_CacheService2() throws Exception {
        ...
        org.turing.designpattern.service.abstractfactory.v2.CacheService proxy_EGM = JDKProxy
                .getProxy(org.turing.designpattern.service.abstractfactory.v2.impl.CacheServiceImpl.class, new EGMCacheAdapter());
        proxy_EGM.set("user_name_01", "小傅哥");
        String val01 = proxy_EGM.get("user_name_01");
        System.out.println("测试结果：" + val01);

        org.turing.designpattern.service.abstractfactory.v2.CacheService proxy_IIR = JDKProxy
                .getProxy(org.turing.designpattern.service.abstractfactory.v2.impl.CacheServiceImpl.class, new IIRCacheAdapter());
